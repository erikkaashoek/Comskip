                              ...
                              AVPacket *pkt)
{
 ...
 redo:
    ...
    if(es_type > 0){
        ...
        type = CODEC_TYPE_AUDIO;
        codec_id = m->sofdec > 0 ? /*CODEC_ID_ADPCM_ADX*/ CODEC_ID_PROBE  : CODEC_ID_MP2;
        ...
        codec_id = /* CODEC_ID_PCM_DVD */ CODEC_ID_PROBE;
        ...
        codec_id = /* CODEC_ID_DVD_SUBTITLE */ CODEC_ID_PROBE;
